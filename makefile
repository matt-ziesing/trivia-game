...
debug: categoryPickerUnitTests.h questionDisplayUnitTests.h correctTotalUnitTests.h AnswerCheckUnitTests.h LeaderBoardUnitTests.h GameResetUnitTests.h AnswerCheck.cpp GameReset.cpp LeaderBoard.cpp LeaderScores.cpp CorrectTotal.cpp CategoryPicker.cpp QuestionDisplay.cpp History.cpp VideoGames.cpp GeneralKnowledge.cpp Sports.cpp Music.cpp Science.cpp unitTesting-main.cpp
	g++ -Wall -o debug categoryPickerUnitTests.h AnswerCheckUnitTests.h questionDisplayUnitTests.h correctTotalUnitTests.h LeaderBoardUnitTests.h AnswerCheck.cpp GameResetUnitTests.h GameReset.cpp LeaderBoard.cpp LeaderScores.cpp CorrectTotal.cpp CategoryPicker.cpp QuestionDisplay.cpp History.cpp VideoGames.cpp GeneralKnowledge.cpp Sports.cpp Music.cpp Science.cpp unitTesting-main.cpp