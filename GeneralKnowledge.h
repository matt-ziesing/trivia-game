#ifndef GENERALKNOWLEDGE_H
#define GENERALKNOWLEDGE_H

#include "CategoryPicker.h"

class GeneralKnowledge : public CategoryPicker {
private:
...
public:
    GeneralKnowledge(); // default constructor for the history class
    ...
    ~GeneralKnowledge(); // default destructor for the history class
} ;
