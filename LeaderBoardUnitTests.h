...
private:
    ...
    void updateLeaderBoardTest() {
        ...
        cout << endl << "when prompted for input, please enter 'test'" << endl;
        ...
        cout << endl << "when prompted for input, please enter 'dhjadkjsajkdakdnkjsan'" << endl;
        ...
        cout << endl << "when prompted for input, please enter '28391820380'" << endl;
